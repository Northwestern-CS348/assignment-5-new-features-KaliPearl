...
##### Your code to extractSubject here
    subject = languageTools.extractSubjectDeep(root) # should I used deep or normal extract subject??
...
##### Your code to resolveObjectFOPC here -- this will build some FOPC and Assert it
    ...
    core.findAndAttachPrepObjectsFOPC(root, subject, listofreferences)
...
##### Your code to findAndAssertDefinitionsFOPC -- this takes the root and your names
    core.findAndAssertDefinitionsFOPC(root, listofreferences)